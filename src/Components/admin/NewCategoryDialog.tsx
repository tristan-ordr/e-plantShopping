...
export default function NewCategoryDialog(props: SimpleDialogProps) {
                ...
                <div className="flex flex-col space-y-6">
                    ...
                    <form name="Insert category" className="space-y-5 mt-6">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex items-center relative w-full"><input id="input-default-:r7l:"
                              name="default"
                        ...
                        <div className="flex space-x-4 justify-end">
                            <button
                                ...
                                type="button"><span className="inline-block">Cancel</span></button>
                            <button
                                ...
                                <span className="inline-block">Add category</span></button>
                        </div>
                    </form>
                </div>
            </div>
